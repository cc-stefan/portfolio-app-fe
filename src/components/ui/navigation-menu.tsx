...
function NavigationMenuLink({ asChild = false, className, ...props }: NavigationMenuLinkProps) {
  ...
  return (
    <Comp
      ...
      className={cn(
        'shrink-0 whitespace-nowrap rounded-lg px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary/80 hover:text-foreground focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring/45',
        className
      )}
      {...props}
    />
