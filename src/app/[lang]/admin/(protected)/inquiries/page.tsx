...
export async function generateMetadata({ params }: AdminInquiriesPageProps): Promise<Metadata> {
...
export default async function AdminInquiriesPage({ params }: AdminInquiriesPageProps) {
  const { lang } = await params;
