  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button type="button" variant="outline" size="icon" aria-label={dictionary.admin.openMenu}>
          <Menu className="size-4" />
        </Button>
      </SheetTrigger>
      <SheetContent className="mobile-nav-glass gap-7" closeLabel={dictionary.admin.closeMenu}>
        <div className="space-y-2 pr-10">
          <SheetTitle>{dictionary.admin.brand}</SheetTitle>
          <SheetDescription className="sr-only">{dictionary.admin.brand}</SheetDescription>
        </div>
        ...
        <div className="grid gap-3">
          <ActionLink lang={lang} href="/" label={dictionary.admin.viewSite} variant="outline" />
        </div>
        ...
        <div className="mt-auto grid gap-3">
          ...
          <div className="flex items-center justify-between gap-3 rounded-xl border border-border bg-secondary px-4 py-3">
            ...
            <ThemeToggle label={dictionary.header.themeLabel} className="shrink-0" />
          </div>
